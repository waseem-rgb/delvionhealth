  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">Revenue breakdown by B2B channels and accounts</p>
      </div>
        ...
        <div className="space-y-3">
          {CHANNELS.map((ch) => (
            <div key={ch.label} className="flex items-center gap-3">
              <ch.icon className="h-4 w-4 text-slate-400 flex-shrink-0" />
              <span className="text-slate-300 text-sm w-40 flex-shrink-0">{ch.label}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
          <h2 className="text-white font-semibold mb-4">Outstanding Ageing</h2>
          <div className="grid grid-cols-4 gap-3 text-center">
            {["0-30 days", "31-60 days", "61-90 days", "90+ days"].map((bucket) => (
              <div key={bucket} className="bg-slate-800 rounded-lg p-3">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
          <h2 className="text-white font-semibold mb-4">Top 10 Accounts by Revenue</h2>
