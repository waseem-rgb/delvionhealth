  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Patient Segments</h1>
            ...
            >
              <div className="mb-3 flex items-start justify-between">
                ...
                <div className="flex gap-2">
                  <span
                    className={`rounded-full border px-2.5 py-0.5 text-xs font-medium ${TYPE_COLORS[seg.type] ?? "bg-slate-700 text-slate-300"}`}
                  >
                    {seg.type}
                  </span>
                  {seg.isSystem && (
              ...
              {seg.description && (
                <p className="mb-3 text-sm text-slate-400">{seg.description}</p>
              )}
